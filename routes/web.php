...
Route::prefix('admin')->group(function() {
  ...
  Route::get('/vendor/subscription/{id}', 'Admin\VendorController@subscription')->name('admin-vendor-subscription-index');
  Route::post('/vendor/subscription/store', 'Admin\VendorController@subscriptionUpdate')->name('admin-vendor-subscription-store');
