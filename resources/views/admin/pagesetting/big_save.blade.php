                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="col-lg-6">
                              <div class="action-list">
                                  <select class="process select droplinks {{ $data->is_big_save_banner == 1 ? 'drop-success' : 'drop-danger' }}">
                                    <option data-val="1" value="{{route('admin-ps-status',['is_big_save_banner',1])}}" {{ $data->is_big_save_banner == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                                    <option data-val="0" value="{{route('admin-ps-status',['is_big_save_banner',0])}}" {{ $data->is_big_save_banner == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                                  </select>
                                </div>
                          </div>
                        </div>
