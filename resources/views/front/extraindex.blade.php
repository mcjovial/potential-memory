	...
	@if($ps->best == 1)
		...
		<section class="phone-and-accessories categori-item">
			<div class="container">
				...
				<div class="row">
					<div class=" {{$ps->is_seller_banner == 1 ? 'col-lg-9' : 'col-lg-12'}} ">
						<div class="row">
	...
	@if($ps->big == 1)
		...
		<section class="categori-item clothing-and-Apparel-Area">
			<div class="container">
				...
				<div class="row">
					<div class="{{$ps->is_big_save_banner == 1 ? 'col-lg-9' : 'col-lg-12'}}">
						<div class="row">
