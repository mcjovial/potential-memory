...
--
-- Host: localhost
-- Generation Time: Feb 13, 2022 at 02:00 PM
...
(1, 'Admin', 'admin@gmail.com', '01629552892', 0, '1556780563user.png', '$2y$10$p35S2FczpEfpbe41CX4j4.XE548tHBtF5weGLPxZ56MX5dsOFtaCC', 1, 'hBrSguZJUAaNyXPOfYHWsGRZFtQQifu1kEacuaQIZNuIqGnUbmxMqJRvJhhS', '2018-02-28 23:27:08', '2019-07-26 21:21:32', 'Genius Store'),
...
(17, 'browser', 'Ubuntu', 72, 0, NULL),
(18, 'browser', 'iPhone', 4, 0, NULL),
(19, 'referral', 'localhost', 49, 0, NULL);
...
CREATE TABLE `generalsettings` (
  ...
  `is_physical` tinyint(4) DEFAULT 1,
  `is_digital` tinyint(4) DEFAULT 1,
  `is_license` tinyint(4) DEFAULT 1,
  `is_affiliate` tinyint(4) DEFAULT 1,
  `is_bulk` tinyint(4) DEFAULT 1,
  `is_right_banner1` tinyint(4) DEFAULT 1,
  `is_right_banner2` tinyint(4) DEFAULT 1
...
(1, '2021_12_29_083457_add_some_fields_to_generalsettings_table', 1),
(2, '2021_12_30_044549_add_meta_description_fields_to_seotools_table', 2),
(4, '2021_12_30_064738_add_some_fields_to_pagesettings_table', 3);
...
(35, NULL, 29, NULL, NULL, NULL, 0, '2022-02-13 09:33:48', '2022-02-13 09:33:48');
...
INSERT INTO `orders` (`id`, `user_id`, `cart`, `method`, `shipping`, `pickup_location`, `totalQty`, `pay_amount`, `txnid`, `charge_id`, `order_number`, `payment_status`, `customer_email`, `customer_name`, `customer_country`, `customer_phone`, `customer_address`, `customer_city`, `customer_zip`, `shipping_name`, `shipping_country`, `shipping_email`, `shipping_phone`, `shipping_address`, `shipping_city`, `shipping_zip`, `order_note`, `coupon_code`, `coupon_discount`, `status`, `created_at`, `updated_at`, `affilate_user`, `affilate_charge`, `currency_sign`, `currency_value`, `shipping_cost`, `packing_cost`, `tax`, `dp`, `pay_id`, `vendor_shipping_id`, `vendor_packing_id`, `whole_discount`) VALUES
(70, 13, '{\"totalQty\":1,\"totalPrice\":120,\"items\":{\"99S000000\":{\"qty\":1,\"size_key\":0,\"size_qty\":\"2147483633\",\"size_price\":\"20\",\"size\":\"S\",\"color\":\"000000\",\"stock\":null,\"price\":120,\"item\":{\"id\":99,\"user_id\":\"13\",\"slug\":\"physical-product-title-title-will-be-here-99-hjm99shr\",\"name\":\"Physical Product Title Title will Be Here 99\",\"photo\":\"15680264040zpMCpmS.png\",\"size\":[\"S\"],\"size_qty\":[\"2147483633\"],\"size_price\":[\"20\"],\"color\":[\"#000000\",\"#851818\",\"#ff0d0d\",\"#1feb4c\",\"#d620cf\",\"#186ceb\"],\"price\":120,\"stock\":null,\"type\":\"Physical\",\"file\":null,\"link\":null,\"license\":\"\",\"license_qty\":\"\",\"measure\":null,\"whole_sell_qty\":[\"10\",\"20\",\"30\",\"40\"],\"whole_sell_discount\":[\"5\",\"10\",\"15\",\"20\"],\"attributes\":null},\"license\":\"\",\"dp\":\"0\",\"keys\":\"\",\"values\":\"\",\"item_price\":120}}}', 'Stripe', 'shipto', 'Azampur', '1', 120, 'txn_3KCG9cJlIV5dN9n709aDw2GD', 'ch_3KCG9cJlIV5dN9n70CQ6dAiv', 'hFvsMtJ99y', 'Completed', 'vendor@gmail.com', 'Vendor', 'Algeria', '3453453345453411', 'Space Needle 400 Broad St, Seattles', 'Washington, DC', '1234', NULL, 'Algeria', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'pending', '2021-12-29 22:22:17', '2021-12-29 22:22:17', NULL, NULL, '$', 1, 0, 0, 0, 0, NULL, 0, 0, 0);
...
(23, 70, 'Pending', 'You have successfully placed your order.', '2021-12-29 22:22:17', '2021-12-29 22:22:17');
...
CREATE TABLE `pagesettings` (
  ...
  `is_seller_banner` tinyint(4) DEFAULT 1,
  `is_big_save_banner` tinyint(4) DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(99, 'pr604jsv', 'normal', NULL, 13, 5, 7, NULL, NULL, 'Physical Product Title Title will Be Here 99', 'physical-product-title-title-will-be-here-99-hjm99shr', '15680264040zpMCpmS.png', '1568026404Hm4kTmnP.jpg', NULL, 'S', '2147483632', '20', '#000000,#851818,#ff0d0d,#1feb4c,#d620cf,#186ceb', 100, 200, '<p style=\"margin-right: 0px; margin-bottom: 15px; margin-left: 0px; padding: 0px; text-align: justify; color: rgb(0, 0, 0); font-family: \" open=\"\" sans\",=\"\" arial,=\"\" sans-serif;=\"\" font-size:=\"\" 14px;\"=\"\">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source. Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of \"de Finibus Bonorum et Malorum\" (The Extremes of Good and Evil) by Cicero, written in 45 BC. This book is a treatise on the theory of ethics, very popular during the Renaissance. The first line of Lorem Ipsum, \"Lorem ipsum dolor sit amet..\", comes from a line in section 1.10.32.</p><p style=\"margin-right: 0px; margin-bottom: 15px; margin-left: 0px; padding: 0px; text-align: justify; color: rgb(0, 0, 0); font-family: \" open=\"\" sans\",=\"\" arial,=\"\" sans-serif;=\"\" font-size:=\"\" 14px;\"=\"\">The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from \"de Finibus Bonorum et Malorum\" by Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by H. Rackham.</p>', NULL, '<p style=\"margin-right: 0px; margin-bottom: 15px; margin-left: 0px; padding: 0px; text-align: justify; color: rgb(0, 0, 0); font-family: \" open=\"\" sans\",=\"\" arial,=\"\" sans-serif;=\"\" font-size:=\"\" 14px;\"=\"\">Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of \"de Finibus Bonorum et Malorum\" (The Extremes of Good and Evil) by Cicero, written in 45 BC. This book is a treatise on the theory of ethics, very popular during the Renaissance. The first line of Lorem Ipsum, \"Lorem ipsum dolor sit amet..\", comes from a line in section 1.10.32.</p><p style=\"margin-right: 0px; margin-bottom: 15px; margin-left: 0px; padding: 0px; text-align: justify; color: rgb(0, 0, 0); font-family: \" open=\"\" sans\",=\"\" arial,=\"\" sans-serif;=\"\" font-size:=\"\" 14px;\"=\"\">The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from \"de Finibus Bonorum et Malorum\" by Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by H. Rackham.</p>', 1, 23, 'clothing,bag', NULL, NULL, 2, '5-7 days', 0, 'clothing,bag', 'clothing, bag', 'https://www.youtube.com/watch?v=HxNydN5tScI', 'Physical', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, 0, 0, 0, 0, 0, 0, '2019-09-09 11:59:33', '2021-12-29 22:22:17', 0, NULL, '10,20,30,40', '5,10,15,20', 1, 0),
...
(1, '<script>//Google Analytics Scriptfffffffffffffffffffffffssssfffffs</script>', 'Genius,Ocean,Sea,Etc,Genius,Ocean,SeaGenius,Ocean,Sea,Etc,Genius,Ocean,SeaGenius,Ocean,Sea,Etc,Genius,Ocean,Sea', 'ASDFAD');
...
(13, 'Vendor', '1557677677bouquet_PNG62.png', '1234', 'Washington, DC', 'Algeria', 'Space Needle 400 Broad St, Seattles', '3453453345453411', '23123121', 'vendor@gmail.com', '$2y$10$.4NrvXAeyToa4x07EkFvS.XIUEc/aXGsxe1onkQ.Udms4Sl2W9ZYq', 'AerZEkmKIgdkMxaFX5hjmdMYx3W2ToqLiPpwyCGdnF2LGq38xyabahJCS6pb', '2018-03-07 18:05:44', '2021-12-29 21:55:58', 0, 2, '$2y$10$oIf1at.0LwscVwaX/8h.WuSwMKEAAsn8EJ.9P7mWzNUFIcEBQs8ry', 'Yes', '$2y$10$oIf1at.0LwscVwaX/8h.WuSwMKEAAsn8EJ.9P7mWzNUFIcEBQs8rysdfsdfds', 5000, 'Test Stores', 'User', '43543534', 'Space Needle 400 Broad St, Seattles', 'asdasd', 'sdf', '<br>', NULL, NULL, NULL, NULL, NULL, 2, 0, 0, 0, 0, 1, 0, 4978.02, '2023-12-30', 0),
...
(29, 'Emmanuel Elias', NULL, NULL, NULL, NULL, 'Nsukka', '09038821990', NULL, 'emmanueleias455@gmail.com', '$2y$10$1yHv1jYFumwXk2c2abToKu3HjOl2vK8UIzXjeDsaq6Kj4udMG/5ai', NULL, '2022-02-13 09:33:48', '2022-02-13 09:33:48', 0, 0, 'a5b8fc2dccb2f96502f38eeab7e1d301', 'Yes', '67cb1985930b045fed017d3e9a43f08c', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, 0, 0, NULL, 0);
...
(24, 13, 'hFvsMtJ99y', 0, '2021-12-29 22:22:17', '2021-12-29 22:22:17');
...
(86, 13, 5, 'Standard', '$', 'USD', 60, 45, 25, '<ol><li>Lorem ipsum dolor sit amet<br></li><li>Lorem ipsum dolor sit ame<br></li><li>Lorem ipsum dolor sit am<br></li></ol>', 'Paypal', NULL, NULL, '2021-12-28 23:59:03', '2021-12-28 23:59:03', 0, NULL),
(87, 13, 5, 'Standard', '$', 'USD', 60, 45, 25, '<ol><li>Lorem ipsum dolor sit amet<br></li><li>Lorem ipsum dolor sit ame<br></li><li>Lorem ipsum dolor sit am<br></li></ol>', 'Stripe', 'txn_3KBvCSJlIV5dN9n7037D60Xz', 'ch_3KBvCSJlIV5dN9n70T1tY4cs', '2021-12-28 23:59:48', '2021-12-28 23:59:48', 1, NULL),
(88, 13, 7, 'Unlimited', '$', 'USD', 250, 365, 0, '<span style=\"color: rgb(0, 0, 0); font-family: \" open=\"\" sans\",=\"\" arial,=\"\" sans-serif;=\"\" text-align:=\"\" justify;\"=\"\">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</span><br>', 'By Admin', 'zU9WHsZJ', NULL, '2021-12-29 21:53:10', '2021-12-29 21:53:10', 1, NULL),
(89, 13, 7, 'Unlimited', '$', 'USD', 250, 365, 0, '<span style=\"color: rgb(0, 0, 0); font-family: \" open=\"\" sans\",=\"\" arial,=\"\" sans-serif;=\"\" text-align:=\"\" justify;\"=\"\">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</span><br>', 'By Admin', 'aL3mypdH', NULL, '2021-12-29 21:55:58', '2021-12-29 21:55:58', 1, NULL);
...
(25, 13, 70, 1, 120, 'hFvsMtJ99y', 'pending');
